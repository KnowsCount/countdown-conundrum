...
const NumbersGame: React.FC<NumbersGameProps> = ({ startCountdown, timeLeft }) => {
  ...
  return (
    <>
      ...
      <ButtonWrapper>
        <Button onClick={() => generateNumbers(true)}>Generate Large Number</Button>
        <Button onClick={() => generateNumbers(false)}>Generate Small Number</Button>
      </ButtonWrapper>
      <input
        type="text"
